...
#'  statistic as well as the ANOVA-type statistic for multivariate designs with
#'  metric data as described in Konietschke et al. (2015). These are even applicable
#'  for non-normal error terms, different sample sizes and/or
#'  heteroscedastic variances. It is implemented for designs with an arbitrary
